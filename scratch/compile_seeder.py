...
seeder_content = """from sqlalchemy.orm import Session
...
with open("app/db/seed_ncert.py", "w", encoding="utf-8") as f:
    f.write(seeder_content)
print("Syllabus written to app/db/seed_ncert.py successfully.")
